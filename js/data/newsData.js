document.addEventListener("DOMContentLoaded", function () {
  ...
  const masonryArticles = [
    {
      ...
      content:
        "陽光灑落的清晨，用豐盛的自助早餐展開旅程！即日起至8月31日，凡預訂雙人房，皆享免費早餐與延遲退房，讓假期慢慢過。",
      category: "住宿優惠",
    },
    {
      ...
      title: "連住兩晚享第2晚半價",
      content:
        "連續入住兩晚即可享有第2晚五折優惠，讓你省更多、玩更久，輕鬆延長假期的美好時光！",
      category: "住宿優惠",
    },
    {
      ...
      title: "免費腳踏車租借服務",
      content:
        "入住期間免費提供腳踏車租借服務，騎乘漫遊在地巷弄，體驗最地道的城市風景。",
      category: "住宿優惠",
    },
    {
      ...
      title: "情侶入住送紅酒與花束",
      content:
        "即日起至七夕，預訂雙人房即贈進口紅酒與精緻花束，為你的浪漫時光增添濃情蜜意。",
      category: "住宿優惠",
    },
    {
      ...
      title: "入住即享觀景酒吧9折券",
      content:
        "凡入住即贈觀景酒吧9折優惠券，夜晚小酌同時飽覽城市夜景，享受不一樣的放鬆時刻。",
      category: "住宿優惠",
    },

    {
      ...
      title: "入住即贈台灣高鐵折價券",
      content:
        "旅行從抵達就開始有驚喜！凡預訂本飯店任一房型，即可獲得高鐵NT$100折價券，輕鬆節省交通費，旅程更愉快。",
      category: "住宿優惠",
    },
    {
      ...
      title: "三天兩夜旅遊行程推薦",
      content:
        "高雄必玩景點一次包辦！入住本飯店可搭配港灣導覽行程，帶你走訪駁二、旗津與蓮池潭，拍出滿滿旅遊回憶。",
      category: "活動訊息",
    },
    {
      ...
      title: "親子友善！兒童免費入住專案",
      content:
        "孩子的笑容，是旅程最美的風景！12歲以下兒童免費加床，再送遊戲禮包，全家出遊超值又開心。",
      category: "活動訊息",
    },
    {
      ...
      title: "親子同樂！周末氣球魔術秀",
      content:
        "每週六下午限定演出，魔術師與可愛氣球造型陪伴孩子歡樂時光，適合全家一同參與！",
      category: "活動訊息",
    },
    {
      ...
      title: "週年慶住房送晚餐套餐",
      content:
        "舌尖上的假期盛宴！慶祝週年，凡平日入住即贈雙人晚餐套餐，美味饗宴為您的旅程添上圓滿句點。",
      category: "餐飲優惠",
    },
    {
      ...
      title: "夏日午後茶免費招待",
      content:
        "沁涼午後時光，凡週末入住即享雙人精緻下午茶組合，甜點與茶香交織的幸福午後等您來體驗。",
      category: "餐飲優惠",
    },
    {
      ...
      title: "入住即享迎賓飲品",
      content:
        "熱情迎接每位旅人，凡入住即可享受精選迎賓飲品一杯，啟動美好假期的第一站。",
      category: "餐飲優惠",
    },
    {
      ...
      title: "在地藝文展覽體驗",
      content:
        "欣賞在地藝術展覽，感受文化氛圍！飯店周邊藝文空間合作展出，住客憑房卡即可免費入場。",
      category: "藝文活動",
    },
    {
      ...
      title: "週末現場音樂會之夜",
      content:
        "沉浸在音樂的魅力中！每週五晚間於戶外花園舉辦現場音樂會，邀您共度悠揚夜晚。",
      category: "藝文活動",
    },
    {
      ...
      title: "在地香氛蠟燭手作體驗",
      content:
        "親手製作專屬香氛蠟燭，帶回旅行的美好記憶。每週日下午開課，名額有限，敬請提前報名。",
      category: "藝文活動",
    },
  ];
  ...
  groups.forEach((group) => {
    ...
    const matched = shuffle(
      masonryArticles.filter((a) => a.category === category)
    );
    ...
    group.innerHTML = `
        ...
        ${matched
            .map(
            (article) => `
        <a href="news_detail.html" class="cardAnime col-12 col-md-6">
            <div class="card">
            <div class="imgBox">
                <img src="${article.img}" class="" alt="${article.title}" />
            </div>
            <div class="card-body">
           <div id="dateList"></div>
...
//   日期
// 省略前面部分... 保留你原本的 DOMContentLoaded 與資料陣列

const WEEKDAYS = ['日', '一', '二', '三', '四', '五', '六'];
const today = new Date();

// 建立「依序 n 天後」的日期字串（例如 6.20 四）
function getDateMark(index) {
  ...
  return `
    <div class="date-mark">
      ...
      <span class="circle"><span class="weekday">${weekday}</span></span>
    </div>
  `;
}
  ...
  group.innerHTML = `
    <div class="row g-5">
      ${matched
        .map(
          (article, index) => {
            const d = new Date(); // 基準日 = 今天
            d.setDate(d.getDate() - index); // 每張卡依序加一天
            ...
            return `
              <a href="news_detail.html" class="cardAnime col-12 col-md-12 col-lg-6">
                <div class="card">
                  <div class="imgBox">
